...
export MINI_S3_CREDENTIALS_JSON="${MINI_S3_CREDENTIALS_JSON:-{\"$ACCESS_KEY\":\"$SECRET_KEY\"}}"
export MINI_S3_PUBLIC_READ_ALL_BUCKETS="${MINI_S3_PUBLIC_READ_ALL_BUCKETS:-true}"
