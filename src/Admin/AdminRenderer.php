...
final class AdminRenderer
{
    ...
    private function filesModal(): string
    {
        return '<div x-dialog x-model="dialogOpen" x-cloak class="dialog-shell">'
            ...
            . '</div>'
            . '<label x-show="!dialogShowFile" x-cloak>Name<input x-model="dialogName"></label>'
    ...
    private function filesScript(): string
    {
        return '<script>'
            ...
            . 'openDialog(title,message,action,path,name,showFile){this.dialogTitle=title;this.dialogMessage=message||"";this.dialogAction=action;this.dialogPath=path||"";this.dialogName=name||"";this.dialogShowFile=showFile;this.dialogOpen=true;this.busy=false;},'
